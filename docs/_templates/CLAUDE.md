...
- Keep the spec order `Goal -> Acceptance criteria (verbatim transcription) -> Design -> Requirements -> Tasks`, dropping the transcription section only when the card has no acceptance criteria to copy; pipeline agents parse that contract.
