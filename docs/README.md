...
The durable engineering knowledge for `ca77y-agentic`. This repository is an Obsidian vault; open the repository root in Obsidian to use the templates, graph, and backlinks. Work itself is tracked in Linear, not here — see [`ISSUE_TRACKING.md`](./ISSUE_TRACKING.md).
