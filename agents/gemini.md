...
5. If every retry fails, report the exact failure class and attempt count. Do not silently substitute a Claude-native pass unless the caller asks for one.
